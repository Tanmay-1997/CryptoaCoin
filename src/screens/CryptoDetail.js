...
import { dummyData, COLORS, icons, FONTS, SIZES } from "../constants";


const CryptoDetail = ({ route, navigation }) => {

    const scrollX = new Animated.Value(0);
    const numberOfCharts = [1, 2, 3, 4]
                    ...
                    <View>
                        ...
                        <Text style={{
                            color: selectedCurrency?.type == "I"
                                ? COLORS.green : COLORS.red, ...FONTS.body3
                        }}>
                           ...
                           return (
                               <TextButton
                                   ...
                                   customContainerStyle={{
                                       ...
                                       borderRadius:10,
                                       backgroundColor:
                                       selectedOption.id == option.id ? COLORS.primary
                                       : COLORS.lightGray,
                                       justifyContent:'space-around'
                                   }}
                                   customLabelStyle={{
                                       color: selectedOption.id == option.id ? COLORS.
                                       white : COLORS.gray, ...FONTS.body5
                                   }}
