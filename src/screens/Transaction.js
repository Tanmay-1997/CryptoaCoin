...
import { dummyData, COLORS, FONTS, SIZES,icons, image } from "../constants";
    ...
    function renderTrade(params) {
        return (
            ...
            >
                ...
                >
                    <Text style={{...FONTS.h2,fontWeight:'bold'}}>{selectedCurrency?.wallet.crypto}
                    {selectedCurrency?.code}</Text>
                    <Text style={{color: COLORS.red, ...FONTS.body4,fontWeight:'bold'}}>
